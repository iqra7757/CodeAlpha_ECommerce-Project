...
public partial class CodeAlphaEcommerceDbContext : DbContext
{
    public CodeAlphaEcommerceDbContext()
    {
    }

    public CodeAlphaEcommerceDbContext(DbContextOptions<CodeAlphaEcommerceDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-9Q37BLO\\SQLEXPRESS;Database=CodeAlpha_EcommerceDB;Trusted_Connection=True;TrustServerCertificate=True;MultipleActiveResultSets=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.Property(e => e.CustomerName)
                .HasMaxLength(100)
                .HasDefaultValue("Guest Customer");
